...
resourcename="cardealershipdatabaseiter11"  # lower case, only
resourcegroup="cardealershipdatabaseiter11_rg"
...
# git clone https://github.com/apilogicserver/cardealershipdatabaseiter11.git
# cd cardealershipdatabaseiter11
...
az group create --name cardealershipdatabaseiter11_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group cardealershipdatabaseiter11_rg --sku S1 --is-linux
az container create --resource-group cardealershipdatabaseiter11_rg --name cardealershipdatabaseiter11 --image apilogicserver/cardealershipdatabaseiter11:latest --dns-name-label cardealershipdatabaseiter11 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//cardealershipdatabaseiter11.westus.azurecontainer.io:5656'
